...
from .gemini import Completion, GeminiProvider, tool_specs_to_gemini  # noqa: F401
...
def get_provider(model: str | None = None, provider: str | None = None, *,
    ...
    if kind == "gemini":
        return GeminiProvider(model=model, temperature=temperature, use_cache=use_cache,
