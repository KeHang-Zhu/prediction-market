...
# default demo scenario, resolved relative to the project root (CWD-independent) so the web
# app auto-inits no matter where it's launched from. Override with GMS_DEMO_CONFIG.
DEMO_CONFIG = Path(os.environ.get(
    "GMS_DEMO_CONFIG", str(Path(__file__).resolve().parents[2] / "scenarios" / "demo.yaml")))
